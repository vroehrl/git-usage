...
sods_data <- read.csv("C:/Users/vinay/Documents/Oxford uni stuff/Ox Uni Year 3/Computer skills/gitusage/data/stackoverflow-git-data.csv")
names(sods_data)[1]<-"year"
